...
type AllTypes struct {
	...
	Int8            int8          `flag:"int8,i8"         env:"INT8"              default:"64"        desc:"8-bit int"`
	Int16           int16         `flag:"int16,i16"       env:"INT16"             default:"128"       desc:"16-bit int"`
	Int32           int32         `flag:"int32,i32"       env:"INT32"             default:"256"       desc:"32-bit int"`
	Int64           int64         `flag:"int64, i64"      env:"INT64"             default:"512"       desc:"64-bit int"`
	Uint            uint          `flag:"uint"            env:"UINT"              default:"1000"      desc:"Uint"`
	Uint8           uint8         `flag:"uint8,u8"        env:"UINT8"             default:"64"        desc:"8-bit uint"`
	Uint16          uint16        `flag:"uint16,u16"      env:"UINT16"            default:"128"       desc:"16-bit uint"`
	Uint32          uint32        `flag:"uint32,u32"      env:"UINT32"            default:"256"       desc:"32-bit uint"`
	Uint64          uint64        `flag:"uint64, u64"     env:"UINT64"            default:"512"       desc:"64-bit uint"`
	Float64         float64       `flag:"float64, f64"    env:"FLOAT64"           default:"1000"      desc:"64-bit float"`
