...
type AllTypes struct {
	...
	Int8            int8          `flag:"int8,i8"         env:"INT8,I8"           default:"64"        desc:"8-bit int"`
	Int16           int16         `flag:"int16,i16"       env:"INT16,I16"         default:"128"       desc:"16-bit int"`
	Int32           int32         `flag:"int32,i32"       env:"INT32,I32"         default:"256"       desc:"32-bit int"`
	Int64           int64         `flag:"int64, i64"      env:"INT64, I64"        default:"512"       desc:"64-bit int"`
	Uint            uint          `flag:"uint"            env:"UINT"              default:"1000"      desc:"Uint"`
	Uint8           uint8         `flag:"uint8,u8"        env:"UINT8,U8"          default:"64"        desc:"8-bit uint"`
